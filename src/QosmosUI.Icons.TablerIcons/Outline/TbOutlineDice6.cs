...
public class TbOutlineDice6 : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(14, "d", "M3 3m0 2a2 2 0 0 1 2 -2h14a2 2 0 0 1 2 2v14a2 2 0 0 1 -2 2h-14a2 2 0 0 1 -2 -2z");
		builder.CloseElement();
		...
		builder.AddAttribute(21, "cx", "15.5");
		builder.AddAttribute(22, "cy", "7.5");
		...
		builder.AddAttribute(31, "cx", "15.5");
		builder.AddAttribute(32, "cy", "12");
		builder.AddAttribute(33, "r", ".5");
		builder.AddAttribute(34, "fill", "currentColor");
		builder.CloseElement();
		builder.OpenElement(35, "circle");
		builder.AddAttribute(36, "cx", "15.5");
		builder.AddAttribute(37, "cy", "16.5");
		builder.AddAttribute(38, "r", ".5");
		builder.AddAttribute(39, "fill", "currentColor");
		builder.CloseElement();
		builder.OpenElement(40, "circle");
		builder.AddAttribute(41, "cx", "8.5");
