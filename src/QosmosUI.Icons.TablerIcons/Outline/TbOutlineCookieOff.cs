...
public class TbOutlineCookieOff : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(14, "d", "M8 13v.01");
		builder.CloseElement();
