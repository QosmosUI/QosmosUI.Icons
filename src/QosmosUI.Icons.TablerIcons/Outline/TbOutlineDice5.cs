...
public class TbOutlineDice5 : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(17, "cy", "8.5");
		...
		builder.AddAttribute(27, "cy", "15.5");
		...
		builder.AddAttribute(32, "cy", "15.5");
