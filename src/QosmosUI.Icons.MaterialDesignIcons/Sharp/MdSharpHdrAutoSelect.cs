...
public class MdSharpHdrAutoSelect : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(20, "points", "3.5,18 1.5,18 1.5,16 0,16 0,22 1.5,22 1.5,19.5 3.5,19.5 3.5,22 5,22 5,16 3.5,16");
		builder.CloseElement();
		builder.OpenElement(21, "path");
		builder.AddAttribute(22, "d", "M10,16H6.5v6H10c0.8,0,1.5-0.7,1.5-1.5v-3C11.5,16.7,10.8,16,10,16z M10,20.5H8v-3h2V20.5z");
		builder.CloseElement();
		...
		builder.AddAttribute(26, "d", "M13,22h1.5v-2h1.1l0.9,2H18l-0.86-2H18v-4h-5V22z M14.5,17.5h2v1h-2V17.5z");
		builder.CloseElement();
