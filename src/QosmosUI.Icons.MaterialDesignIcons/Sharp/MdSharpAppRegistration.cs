...
public class MdSharpAppRegistration : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(44, "y", "4");
		builder.CloseElement();
		builder.OpenElement(45, "polygon");
		builder.AddAttribute(46, "points", "11,17.86 11,20 13.1,20 19.08,14.03 16.96,11.91");
		builder.CloseElement();
		builder.OpenElement(47, "polygon");
		builder.AddAttribute(48, "points", "14,12.03 14,10 10,10 10,14 12.03,14");
		builder.CloseElement();
		builder.OpenElement(49, "rect");
		builder.AddAttribute(50, "height", "3");
		builder.AddAttribute(51, "transform", "matrix(0.7071 -0.7071 0.7071 0.7071 -2.481 17.1312)");
		builder.AddAttribute(52, "width", "2");
		builder.AddAttribute(53, "x", "18.44");
		builder.AddAttribute(54, "y", "10.06");
		builder.CloseElement();
		builder.CloseElement();
		builder.CloseElement();
		builder.CloseElement();
