...
public class MdSharpSpatialAudio : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(27, "d", "M16,1h-2c0,4.97,4.03,9,9,9V8C19.14,8,16,4.86,16,1z");
		builder.CloseElement();
		builder.OpenElement(28, "path");
		builder.AddAttribute(29, "d", "M20,1h-2c0,2.76,2.24,5,5,5V4C21.35,4,20,2.65,20,1z");
		builder.CloseElement();
		builder.CloseElement();
		builder.CloseElement();
		builder.CloseElement();
