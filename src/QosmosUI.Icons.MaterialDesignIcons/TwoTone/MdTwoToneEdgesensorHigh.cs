...
public class MdTwoToneEdgesensorHigh : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(32, "d", "M16,2.01L8,2C6.9,2,6,2.9,6,4v16c0,1.1,0.9,2,2,2h8c1.1,0,2-0.9,2-2V4C18,2.9,17.1,2.01,16,2.01z M16,20H8v-1h8V20z M16,17H8V7h8V17z M16,5H8V4h8V5z");
		builder.CloseElement();
		builder.OpenElement(33, "rect");
		builder.AddAttribute(34, "height", "7");
		builder.AddAttribute(35, "width", "2");
		builder.AddAttribute(36, "x", "19");
		builder.AddAttribute(37, "y", "10");
		builder.CloseElement();
		builder.OpenElement(38, "rect");
		builder.AddAttribute(39, "height", "7");
		builder.AddAttribute(40, "width", "2");
		builder.AddAttribute(41, "x", "22");
		builder.AddAttribute(42, "y", "7");
		builder.CloseElement();
		builder.OpenElement(43, "rect");
		builder.AddAttribute(44, "height", "7");
		builder.AddAttribute(45, "width", "2");
		builder.AddAttribute(46, "x", "3");
		builder.AddAttribute(47, "y", "7");
		builder.CloseElement();
		builder.OpenElement(48, "rect");
		builder.AddAttribute(49, "height", "7");
		builder.AddAttribute(50, "width", "2");
		builder.AddAttribute(51, "y", "10");
		builder.CloseElement();
		builder.CloseElement();
		builder.CloseElement();
		builder.CloseElement();
