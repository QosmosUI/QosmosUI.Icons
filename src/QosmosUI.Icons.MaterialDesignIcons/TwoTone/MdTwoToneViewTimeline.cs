...
public class MdTwoToneViewTimeline : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(21, "d", "M5,19h14V5H5V19z M12,7h6v2h-6V7z M9,11h6v2H9V11z M6,15h6v2H6V15z");
		...
		builder.AddAttribute(31, "x", "12");
		builder.AddAttribute(32, "y", "7");
		builder.CloseElement();
		builder.OpenElement(33, "rect");
		builder.AddAttribute(34, "height", "2");
		builder.AddAttribute(35, "width", "6");
		builder.AddAttribute(36, "x", "9");
		builder.AddAttribute(37, "y", "11");
		builder.CloseElement();
		builder.OpenElement(38, "path");
		builder.AddAttribute(39, "d", "M19,3H5C3.9,3,3,3.9,3,5v14c0,1.1,0.9,2,2,2h14c1.1,0,2-0.9,2-2V5C21,3.9,20.1,3,19,3z M19,19H5V5h14V19z");
		builder.CloseElement();
		builder.CloseElement();
		builder.CloseElement();
		builder.CloseElement();
