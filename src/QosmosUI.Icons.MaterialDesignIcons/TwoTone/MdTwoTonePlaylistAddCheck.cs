...
public class MdTwoTonePlaylistAddCheck : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(36, "points", "20.59,11.93 16.34,16.17 14.22,14.05 12.81,15.46 16.34,19 22,13.34");
		builder.CloseElement();
		builder.CloseElement();
		builder.CloseElement();
		builder.CloseElement();
