...
public class MdTwoToneAppBlocking : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(34, "x", "7");
		builder.AddAttribute(35, "y", "20");
		builder.CloseElement();
		builder.CloseElement();
		builder.CloseElement();
    }
