...
public class MdTwoToneReadMore : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(27, "width", "9");
		builder.AddAttribute(28, "x", "13");
		builder.AddAttribute(29, "y", "15");
		builder.CloseElement();
		...
		builder.AddAttribute(36, "points", "13,12 8,7 8,11 2,11 2,13 8,13 8,17");
		builder.CloseElement();
		builder.CloseElement();
		builder.CloseElement();
		builder.CloseElement();
