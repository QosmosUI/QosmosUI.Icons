...
public class MdTwoTone11mp : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(21, "d", "M5,19h14V5H5V19z M18,13.5V16c0,0.55-0.45,1-1,1h-2v1.5h-1.5v-6H17C17.55,12.5,18,12.95,18,13.5z M13,5.5h3 v6h-1.5V7H13V5.5z M8,5.5h3v6H9.5V7H8V5.5z M6,13.5c0-0.55,0.45-1,1-1h4.5c0.55,0,1,0.45,1,1v5H11V14h-1v3H8.5v-3h-1v4.5H6V13.5z");
		...
		builder.AddAttribute(37, "points", "9.5,11.5 11,11.5 11,5.5 8,5.5 8,7 9.5,7");
		builder.CloseElement();
		builder.CloseElement();
		builder.OpenElement(38, "g");
		builder.OpenElement(39, "polygon");
		builder.AddAttribute(40, "points", "14.5,11.5 16,11.5 16,5.5 13,5.5 13,7 14.5,7");
		builder.CloseElement();
		builder.CloseElement();
		builder.CloseElement();
		builder.CloseElement();
