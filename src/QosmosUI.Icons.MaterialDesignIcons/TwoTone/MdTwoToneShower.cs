...
public class MdTwoToneShower : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(20, "d", "M12,7c-2.76,0-5,2.24-5,5h10C17,9.24,14.76,7,12,7z");
		builder.AddAttribute(21, "opacity", ".3");
		builder.CloseElement();
		builder.OpenElement(22, "circle");
		builder.AddAttribute(23, "cx", "8");
		builder.AddAttribute(24, "cy", "20");
		...
		builder.AddAttribute(31, "d", "M13,5.08V3h-2v2.08C7.61,5.57,5,8.47,5,12v2h14v-2C19,8.47,16.39,5.57,13,5.08z M7,12c0-2.76,2.24-5,5-5s5,2.24,5,5H7z");
		builder.CloseElement();
		builder.OpenElement(32, "circle");
		builder.AddAttribute(33, "cx", "16");
		builder.AddAttribute(34, "cy", "20");
		builder.AddAttribute(35, "r", "1");
		builder.CloseElement();
		builder.OpenElement(36, "circle");
		builder.AddAttribute(37, "cx", "12");
		builder.AddAttribute(38, "cy", "17");
		builder.AddAttribute(39, "r", "1");
		builder.CloseElement();
		builder.OpenElement(40, "circle");
		builder.AddAttribute(41, "cx", "8");
		builder.AddAttribute(42, "cy", "17");
		builder.AddAttribute(43, "r", "1");
		builder.CloseElement();
		builder.OpenElement(44, "circle");
		builder.AddAttribute(45, "cx", "12");
		builder.AddAttribute(46, "cy", "20");
