...
public class MdOutlineMapsHomeWork : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(33, "y", "15");
		builder.CloseElement();
		builder.OpenElement(34, "path");
		builder.AddAttribute(35, "d", "M1,11v10h6v-5h2v5h6V11L8,6L1,11z M13,19h-2v-5H5v5H3v-7l5-3.5l5,3.5V19z");
		builder.CloseElement();
		builder.OpenElement(36, "polygon");
		builder.AddAttribute(37, "points", "10,3 10,4.97 12,6.4 12,5 21,5 21,19 17,19 17,21 23,21 23,3");
		builder.CloseElement();
		builder.CloseElement();
		builder.CloseElement();
		builder.CloseElement();
