...
public class MdRoundDeblur : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(25, "d", "M12,3v18c4.97,0,9-4.03,9-9C21,7.03,16.97,3,12,3z");
		builder.CloseElement();
		...
		builder.AddAttribute(64, "cy", "14");
		builder.AddAttribute(65, "r", "1.5");
		builder.CloseElement();
		builder.OpenElement(66, "circle");
		builder.AddAttribute(67, "cx", "10");
		builder.AddAttribute(68, "cy", "10");
		builder.AddAttribute(69, "r", "1.5");
		builder.CloseElement();
		builder.OpenElement(70, "circle");
		builder.AddAttribute(71, "cx", "10");
		builder.AddAttribute(72, "cy", "18");
		builder.AddAttribute(73, "r", "1");
		builder.CloseElement();
		builder.CloseElement();
		builder.CloseElement();
		builder.CloseElement();
