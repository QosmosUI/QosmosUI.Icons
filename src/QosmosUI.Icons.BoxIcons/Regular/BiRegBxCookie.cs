...
public class BiRegBxCookie : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(32, "cx", "10.5");
		builder.AddAttribute(33, "cy", "16.5");
