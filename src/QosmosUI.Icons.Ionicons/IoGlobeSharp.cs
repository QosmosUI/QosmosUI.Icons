...
public class IoGlobeSharp : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(17, "stroke-width", "44px");
		builder.CloseElement();
		...
		builder.AddAttribute(22, "stroke-width", "44px");
		builder.CloseElement();
		builder.OpenElement(23, "path");
		builder.AddAttribute(24, "d", "M117.33,121.33c38.24,27.15,86.38,43.34,138.67,43.34s100.43-16.19,138.67-43.34");
		...
		builder.AddAttribute(28, "stroke-width", "44px");
		builder.CloseElement();
		builder.OpenElement(29, "path");
		builder.AddAttribute(30, "d", "M394.67,390.67c-38.24-27.15-86.38-43.34-138.67-43.34s-100.43,16.19-138.67,43.34");
		...
		builder.AddAttribute(34, "stroke-width", "44px");
		builder.CloseElement();
		...
		builder.AddAttribute(42, "stroke-width", "44px");
		builder.CloseElement();
		...
		builder.AddAttribute(50, "stroke-width", "44px");
		builder.CloseElement();
		builder.CloseElement();
    }
}
