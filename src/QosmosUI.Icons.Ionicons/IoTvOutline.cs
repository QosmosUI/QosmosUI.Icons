...
public class IoTvOutline : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(18, "rx", "32.14");
		builder.AddAttribute(19, "ry", "32.14");
		...
		builder.AddAttribute(24, "x1", "128");
		builder.AddAttribute(25, "y1", "416");
		builder.AddAttribute(26, "x2", "384");
