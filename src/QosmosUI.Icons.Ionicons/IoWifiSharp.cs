...
public class IoWifiSharp : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(14, "d", "M332.69,320a115,115,0,0,0-152.8,0");
		...
		builder.AddAttribute(20, "d", "M393.74,259a201.26,201.26,0,0,0-274.92,0");
		...
		builder.AddAttribute(26, "d", "M448,191.52a288,288,0,0,0-383.44,0");
		...
		builder.AddAttribute(32, "d", "M300.67,384,256,433l-44.34-49a56.73,56.73,0,0,1,88.92,0Z");
		builder.CloseElement();
		builder.CloseElement();
    }
}
