...
public class IoReturnUpForwardOutline : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(14, "points", "400 160 464 224 400 288");
		...
		builder.AddAttribute(20, "d", "M448,224H154C95.24,224,48,273.33,48,332v20");
