...
public class IoEaselOutline : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(17, "height", "272");
		...
		builder.AddAttribute(24, "x1", "256");
		builder.AddAttribute(25, "y1", "416");
		builder.AddAttribute(26, "x2", "256");
		builder.AddAttribute(27, "y2", "352");
		...
		builder.AddAttribute(34, "y1", "80");
		builder.AddAttribute(35, "x2", "256");
		builder.AddAttribute(36, "y2", "48");
		...
		builder.AddAttribute(42, "x1", "400");
		builder.AddAttribute(43, "y1", "464");
		builder.AddAttribute(44, "x2", "368");
		builder.AddAttribute(45, "y2", "352");
		...
		builder.AddAttribute(52, "y1", "464");
		builder.AddAttribute(53, "x2", "144");
		builder.AddAttribute(54, "y2", "352");
