...
public class IoFlashOffSharp : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(20, "points", "80 304 224 304 192 496 300.18 366.18 151.82 217.82 80 304");
		builder.CloseElement();
		builder.OpenElement(21, "polygon");
		builder.AddAttribute(22, "points", "432 208 288 208 320 16 211.82 145.82 360.18 294.18 432 208");
		builder.CloseElement();
		builder.CloseElement();
    }
}
