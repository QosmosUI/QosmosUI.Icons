...
public class IoChevronUpCircleOutline : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(14, "points", "352 296 256 200 160 296");
		...
		builder.AddAttribute(20, "d", "M256,64C150,64,64,150,64,256s86,192,192,192,192-86,192-192S362,64,256,64Z");
