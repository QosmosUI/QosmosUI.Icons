...
public class IoVolumeMediumSharp : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(14, "points", "157.65 176.1 64 176.1 64 335.9 157.65 335.9 288 440 288 72 157.65 176.1");
		builder.CloseElement();
		builder.OpenElement(15, "path");
		builder.AddAttribute(16, "d", "M352,320c9.74-19.41,16-40.81,16-64,0-23.51-6-44.4-16-64");
		...
		builder.AddAttribute(22, "d", "M400,368c19.48-34,32-64,32-112s-12-77.7-32-112");
