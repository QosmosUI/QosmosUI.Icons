...
public class IoDesktopOutline : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(24, "points", "304 448 296 384 216 384 208 448 304 448");
		...
		builder.AddAttribute(30, "y1", "448");
		builder.AddAttribute(31, "x2", "144");
		...
		builder.AddAttribute(38, "d", "M32,304v48a32.09,32.09,0,0,0,32,32H448a32.09,32.09,0,0,0,32-32V304Zm224,64a16,16,0,1,1,16-16A16,16,0,0,1,256,368Z");
		builder.CloseElement();
		builder.CloseElement();
    }
}
