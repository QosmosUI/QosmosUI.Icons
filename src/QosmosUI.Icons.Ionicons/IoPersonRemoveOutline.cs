...
public class IoPersonRemoveOutline : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(25, "x1", "144");
		builder.AddAttribute(26, "y1", "232");
		builder.AddAttribute(27, "x2", "32");
		builder.AddAttribute(28, "y2", "232");
