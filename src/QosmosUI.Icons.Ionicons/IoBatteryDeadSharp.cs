...
public class IoBatteryDeadSharp : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(23, "x1", "480");
		builder.AddAttribute(24, "y1", "218.67");
		builder.AddAttribute(25, "x2", "480");
		builder.AddAttribute(26, "y2", "293.33");
