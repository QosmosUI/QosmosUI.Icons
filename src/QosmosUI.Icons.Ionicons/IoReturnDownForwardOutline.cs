...
public class IoReturnDownForwardOutline : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(14, "points", "400 352 464 288 400 224");
		...
		builder.AddAttribute(20, "d", "M448,288H154C95.24,288,48,238.67,48,180V160");
