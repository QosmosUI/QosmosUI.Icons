...
public class IoCropOutline : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(14, "d", "M144,48V320a48,48,0,0,0,48,48H464");
		...
		builder.AddAttribute(20, "d", "M368,304V192a48,48,0,0,0-48-48H208");
		...
		builder.AddAttribute(26, "x1", "368");
		builder.AddAttribute(27, "y1", "368");
		builder.AddAttribute(28, "x2", "368");
		builder.AddAttribute(29, "y2", "464");
		...
		builder.AddAttribute(35, "x1", "144");
		builder.AddAttribute(36, "y1", "144");
		builder.AddAttribute(37, "x2", "48");
		builder.AddAttribute(38, "y2", "144");
