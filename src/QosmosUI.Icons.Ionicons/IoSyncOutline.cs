...
public class IoSyncOutline : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(14, "d", "M434.67,285.59v-29.8C434.67,157.06,354.43,77,255.47,77a179,179,0,0,0-140.14,67.36m-38.53,82v29.8C76.8,355,157,435,256,435a180.45,180.45,0,0,0,140-66.92");
		...
		builder.AddAttribute(20, "points", "32 256 76 212 122 256");
		...
		builder.AddAttribute(26, "points", "480 256 436 300 390 256");
