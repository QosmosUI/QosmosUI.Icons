...
public class IoCheckboxOutline : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(14, "points", "352 176 217.6 336 160 272");
		...
		builder.AddAttribute(20, "x", "64");
		builder.AddAttribute(21, "y", "64");
		builder.AddAttribute(22, "width", "384");
		builder.AddAttribute(23, "height", "384");
