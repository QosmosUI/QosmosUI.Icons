...
public class IoArrowUpOutline : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(14, "points", "112 244 256 100 400 244");
		...
		builder.AddAttribute(21, "y1", "120");
		builder.AddAttribute(22, "x2", "256");
		builder.AddAttribute(23, "y2", "412");
