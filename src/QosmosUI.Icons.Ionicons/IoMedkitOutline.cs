...
public class IoMedkitOutline : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(24, "d", "M144,112V80a32,32,0,0,1,32-32H336a32,32,0,0,1,32,32v32");
		...
		builder.AddAttribute(31, "y1", "208");
		...
		builder.AddAttribute(39, "x1", "336");
		builder.AddAttribute(40, "y1", "288");
		builder.AddAttribute(41, "x2", "176");
		builder.AddAttribute(42, "y2", "288");
