...
public class IoRefreshCircleOutline : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(14, "d", "M288,193s12.18-6-32-6a80,80,0,1,0,80,80");
		builder.AddAttribute(15, "fill", "none");
		builder.AddAttribute(16, "stroke-linecap", "round");
		builder.AddAttribute(17, "stroke-miterlimit", "10");
		builder.AddAttribute(18, "stroke-width", "28px");
		builder.CloseElement();
		builder.OpenElement(19, "polyline");
		builder.AddAttribute(20, "points", "256 149 296 189 256 229");
		...
		builder.AddAttribute(24, "stroke-width", "28px");
		builder.CloseElement();
		builder.OpenElement(25, "path");
		builder.AddAttribute(26, "d", "M256,64C150,64,64,150,64,256s86,192,192,192,192-86,192-192S362,64,256,64Z");
