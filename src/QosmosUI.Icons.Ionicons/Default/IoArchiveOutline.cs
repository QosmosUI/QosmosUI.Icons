...
public class IoArchiveOutline : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(14, "d", "M80,152V408a40.12,40.12,0,0,0,40,40H392a40.12,40.12,0,0,0,40-40V152");
		...
		builder.AddAttribute(20, "x", "48");
		builder.AddAttribute(21, "y", "64");
		builder.AddAttribute(22, "width", "416");
		builder.AddAttribute(23, "height", "80");
		builder.AddAttribute(24, "rx", "28");
		builder.AddAttribute(25, "ry", "28");
		...
		builder.AddAttribute(30, "points", "320 304 256 368 192 304");
		...
		builder.AddAttribute(37, "y1", "345.89");
		builder.AddAttribute(38, "x2", "256");
		builder.AddAttribute(39, "y2", "224");
