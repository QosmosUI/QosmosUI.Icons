...
public class IoRefreshOutline : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(14, "d", "M320,146s24.36-12-64-12A160,160,0,1,0,416,294");
		...
		builder.AddAttribute(20, "points", "256 58 336 138 256 218");
