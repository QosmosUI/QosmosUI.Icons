...
public class IoRecordingOutline : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(30, "x1", "128");
		builder.AddAttribute(31, "y1", "352");
		builder.AddAttribute(32, "x2", "384");
		builder.AddAttribute(33, "y2", "352");
