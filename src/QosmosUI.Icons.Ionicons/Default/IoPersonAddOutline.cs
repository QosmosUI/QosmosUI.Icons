...
public class IoPersonAddOutline : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(14, "d", "M376,144c-3.92,52.87-44,96-88,96s-84.15-43.12-88-96c-4-55,35-96,88-96S380,90,376,144Z");
		...
		builder.AddAttribute(20, "d", "M288,304c-87,0-175.3,48-191.64,138.6-2,10.92,4.21,21.4,15.65,21.4H464c11.44,0,17.62-10.48,15.65-21.4C463.3,352,375,304,288,304Z");
		...
		builder.AddAttribute(25, "x1", "88");
		builder.AddAttribute(26, "y1", "176");
		builder.AddAttribute(27, "x2", "88");
		...
		builder.AddAttribute(34, "x1", "144");
		builder.AddAttribute(35, "y1", "232");
		builder.AddAttribute(36, "x2", "32");
		builder.AddAttribute(37, "y2", "232");
