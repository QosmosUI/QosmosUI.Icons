...
public class IoStopwatchOutline : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(15, "y1", "232");
		builder.AddAttribute(16, "x2", "256");
		builder.AddAttribute(17, "y2", "152");
		...
		builder.AddAttribute(24, "y1", "88");
		builder.AddAttribute(25, "x2", "256");
		builder.AddAttribute(26, "y2", "72");
		...
		builder.AddAttribute(32, "x1", "132");
		builder.AddAttribute(33, "y1", "132");
		builder.AddAttribute(34, "x2", "120");
		builder.AddAttribute(35, "y2", "120");
		...
		builder.AddAttribute(41, "cx", "256");
		builder.AddAttribute(42, "cy", "272");
		builder.AddAttribute(43, "r", "32");
		...
		builder.AddAttribute(48, "d", "M256,96A176,176,0,1,0,432,272,176,176,0,0,0,256,96Z");
