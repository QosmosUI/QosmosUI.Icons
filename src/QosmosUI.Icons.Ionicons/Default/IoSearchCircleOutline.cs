...
public class IoSearchCircleOutline : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(19, "d", "M232,160a72,72,0,1,0,72,72A72,72,0,0,0,232,160Z");
		...
		builder.AddAttribute(24, "x1", "283.64");
		builder.AddAttribute(25, "y1", "283.64");
		builder.AddAttribute(26, "x2", "336");
		builder.AddAttribute(27, "y2", "336");
