...
public class IoLinkSharp : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(14, "d", "M200.66,352H144a96,96,0,0,1,0-192h55.41");
		builder.AddAttribute(15, "fill", "none");
		builder.AddAttribute(16, "stroke-linecap", "square");
		builder.AddAttribute(17, "stroke-linejoin", "round");
		builder.AddAttribute(18, "stroke-width", "48px");
		builder.CloseElement();
		builder.OpenElement(19, "path");
		builder.AddAttribute(20, "d", "M312.59,160H368a96,96,0,0,1,0,192H311.34");
		...
		builder.AddAttribute(24, "stroke-width", "48px");
		builder.CloseElement();
		builder.OpenElement(25, "line");
		builder.AddAttribute(26, "x1", "169.07");
		builder.AddAttribute(27, "y1", "256");
		builder.AddAttribute(28, "x2", "344.93");
		builder.AddAttribute(29, "y2", "256");
		...
		builder.AddAttribute(33, "stroke-width", "48px");
		builder.CloseElement();
		builder.CloseElement();
    }
}
