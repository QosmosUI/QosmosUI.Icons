...
public class IoAppsOutline : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(24, "x", "216");
		builder.AddAttribute(25, "y", "64");
		builder.AddAttribute(26, "width", "80");
		builder.AddAttribute(27, "height", "80");
		builder.AddAttribute(28, "rx", "40");
		builder.AddAttribute(29, "ry", "40");
		...
		builder.AddAttribute(34, "x", "368");
		builder.AddAttribute(35, "y", "64");
		builder.AddAttribute(36, "width", "80");
		builder.AddAttribute(37, "height", "80");
		builder.AddAttribute(38, "rx", "40");
		builder.AddAttribute(39, "ry", "40");
		...
		builder.AddAttribute(44, "x", "64");
		builder.AddAttribute(45, "y", "216");
		builder.AddAttribute(46, "width", "80");
		builder.AddAttribute(47, "height", "80");
		builder.AddAttribute(48, "rx", "40");
		builder.AddAttribute(49, "ry", "40");
		...
		builder.AddAttribute(54, "x", "216");
		builder.AddAttribute(55, "y", "216");
		builder.AddAttribute(56, "width", "80");
		builder.AddAttribute(57, "height", "80");
		builder.AddAttribute(58, "rx", "40");
		builder.AddAttribute(59, "ry", "40");
		builder.AddAttribute(60, "fill", "none");
		builder.AddAttribute(61, "stroke-miterlimit", "10");
		builder.AddAttribute(62, "stroke-width", "32px");
		builder.CloseElement();
		builder.OpenElement(63, "rect");
		builder.AddAttribute(64, "x", "368");
		builder.AddAttribute(65, "y", "216");
		builder.AddAttribute(66, "width", "80");
		builder.AddAttribute(67, "height", "80");
		builder.AddAttribute(68, "rx", "40");
		builder.AddAttribute(69, "ry", "40");
		...
		builder.AddAttribute(74, "x", "64");
		builder.AddAttribute(75, "y", "368");
		builder.AddAttribute(76, "width", "80");
		builder.AddAttribute(77, "height", "80");
		builder.AddAttribute(78, "rx", "40");
		builder.AddAttribute(79, "ry", "40");
		builder.AddAttribute(80, "fill", "none");
		builder.AddAttribute(81, "stroke-miterlimit", "10");
		builder.AddAttribute(82, "stroke-width", "32px");
		builder.CloseElement();
		builder.OpenElement(83, "rect");
		builder.AddAttribute(84, "x", "216");
		builder.AddAttribute(85, "y", "368");
		builder.AddAttribute(86, "width", "80");
		builder.AddAttribute(87, "height", "80");
		builder.AddAttribute(88, "rx", "40");
		builder.AddAttribute(89, "ry", "40");
		...
		builder.AddAttribute(94, "x", "368");
		builder.AddAttribute(95, "y", "368");
		builder.AddAttribute(96, "width", "80");
		builder.AddAttribute(97, "height", "80");
		builder.AddAttribute(98, "rx", "40");
		builder.AddAttribute(99, "ry", "40");
