...
public class IoCloseOutline : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(15, "y1", "368");
		builder.AddAttribute(16, "x2", "144");
		...
		builder.AddAttribute(23, "x1", "368");
		builder.AddAttribute(24, "y1", "144");
		builder.AddAttribute(25, "x2", "144");
		builder.AddAttribute(26, "y2", "368");
