...
public class IoJournalOutline : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(24, "x1", "320");
		builder.AddAttribute(25, "y1", "48");
		builder.AddAttribute(26, "x2", "320");
		builder.AddAttribute(27, "y2", "464");
		builder.AddAttribute(28, "fill", "none");
		builder.AddAttribute(29, "stroke-linejoin", "round");
		builder.AddAttribute(30, "stroke-width", "60px");
		builder.CloseElement();
		builder.CloseElement();
    }
}
