...
public class IoGitCommitOutline : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(22, "x1", "160");
		builder.AddAttribute(23, "y1", "256");
		builder.AddAttribute(24, "x2", "48");
		...
		builder.AddAttribute(31, "x1", "464");
		builder.AddAttribute(32, "y1", "256");
		builder.AddAttribute(33, "x2", "352");
		builder.AddAttribute(34, "y2", "256");
