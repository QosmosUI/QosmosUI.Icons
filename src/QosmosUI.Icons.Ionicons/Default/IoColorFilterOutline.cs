...
public class IoColorFilterOutline : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(21, "cx", "344");
		builder.AddAttribute(22, "cy", "328");
		builder.AddAttribute(23, "r", "120");
		...
		builder.AddAttribute(28, "cx", "168");
		builder.AddAttribute(29, "cy", "328");
		builder.AddAttribute(30, "r", "120");
