...
public class IoAlertCircleOutline : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(19, "d", "M250.26,166.05,256,288l5.73-121.95a5.74,5.74,0,0,0-5.79-6h0A5.74,5.74,0,0,0,250.26,166.05Z");
		...
		builder.AddAttribute(25, "d", "M256,367.91a20,20,0,1,1,20-20A20,20,0,0,1,256,367.91Z");
		builder.CloseElement();
		builder.CloseElement();
    }
}
