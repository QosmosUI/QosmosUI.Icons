...
public class IoArrowForwardCircleOutline : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(14, "points", "262.62 336 342 256 262.62 176");
		...
		builder.AddAttribute(20, "x1", "330.97");
		builder.AddAttribute(21, "y1", "256");
		builder.AddAttribute(22, "x2", "170");
		builder.AddAttribute(23, "y2", "256");
		...
		builder.AddAttribute(29, "d", "M256,448c106,0,192-86,192-192S362,64,256,64,64,150,64,256,150,448,256,448Z");
