...
public class IoBanOutline : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(21, "x1", "108.92");
		builder.AddAttribute(22, "y1", "108.92");
		builder.AddAttribute(23, "x2", "403.08");
		builder.AddAttribute(24, "y2", "403.08");
