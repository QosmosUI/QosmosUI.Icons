...
public class IoCloudUploadOutline : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(14, "d", "M320,367.79h76c55,0,100-29.21,100-83.6s-53-81.47-96-83.6c-8.89-85.06-71-136.8-144-136.8-69,0-113.44,45.79-128,91.2-60,5.7-112,43.88-112,106.4s54,106.4,120,106.4h56");
		...
		builder.AddAttribute(20, "points", "320 255.79 256 191.79 192 255.79");
		...
		builder.AddAttribute(27, "y1", "448.21");
		builder.AddAttribute(28, "x2", "256");
		builder.AddAttribute(29, "y2", "207.79");
