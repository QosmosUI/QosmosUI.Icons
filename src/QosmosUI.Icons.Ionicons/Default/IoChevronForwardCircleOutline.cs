...
public class IoChevronForwardCircleOutline : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(14, "d", "M64,256c0,106,86,192,192,192s192-86,192-192S362,64,256,64,64,150,64,256Z");
		...
		builder.AddAttribute(19, "points", "216 352 312 256 216 160");
