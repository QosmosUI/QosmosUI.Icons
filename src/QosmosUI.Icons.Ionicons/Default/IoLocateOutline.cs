...
public class IoLocateOutline : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(37, "x1", "416");
		builder.AddAttribute(38, "y1", "256");
		builder.AddAttribute(39, "x2", "456");
		builder.AddAttribute(40, "y2", "256");
		...
		builder.AddAttribute(44, "stroke-width", "48px");
		builder.CloseElement();
		builder.OpenElement(45, "line");
		builder.AddAttribute(46, "x1", "56");
		builder.AddAttribute(47, "y1", "256");
		builder.AddAttribute(48, "x2", "96");
		builder.AddAttribute(49, "y2", "256");
		...
		builder.AddAttribute(53, "stroke-width", "48px");
		builder.CloseElement();
		builder.CloseElement();
    }
}
