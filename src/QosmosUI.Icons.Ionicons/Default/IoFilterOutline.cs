...
public class IoFilterOutline : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(14, "x1", "32");
		builder.AddAttribute(15, "y1", "144");
		builder.AddAttribute(16, "x2", "480");
		...
		builder.AddAttribute(23, "x1", "112");
		builder.AddAttribute(24, "y1", "256");
		builder.AddAttribute(25, "x2", "400");
		...
		builder.AddAttribute(32, "x1", "208");
		builder.AddAttribute(33, "y1", "368");
		builder.AddAttribute(34, "x2", "304");
