...
public class IoRemoveCircleOutline : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(19, "x1", "336");
		builder.AddAttribute(20, "y1", "256");
		builder.AddAttribute(21, "x2", "176");
		builder.AddAttribute(22, "y2", "256");
