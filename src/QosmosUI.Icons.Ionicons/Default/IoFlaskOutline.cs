...
public class IoFlaskOutline : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(23, "x1", "118");
		builder.AddAttribute(24, "y1", "304");
		builder.AddAttribute(25, "x2", "394");
		builder.AddAttribute(26, "y2", "304");
		...
		builder.AddAttribute(32, "d", "M208,48v93.48a64.09,64.09,0,0,1-9.88,34.18L73.21,373.49C48.4,412.78,76.63,464,123.08,464H388.92c46.45,0,74.68-51.22,49.87-90.51L313.87,175.66A64.09,64.09,0,0,1,304,141.48V48");
