...
public class IoTodayOutline : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(45, "x", "112");
		builder.AddAttribute(46, "y", "224");
		builder.AddAttribute(47, "width", "96");
		builder.AddAttribute(48, "height", "96");
		builder.AddAttribute(49, "rx", "13");
		builder.CloseElement();
		builder.OpenElement(50, "line");
		builder.AddAttribute(51, "fill", "none");
		builder.AddAttribute(52, "stroke-linejoin", "round");
		builder.AddAttribute(53, "stroke-width", "32");
		builder.AddAttribute(54, "stroke-linecap", "round");
		builder.AddAttribute(55, "x1", "464");
		builder.AddAttribute(56, "y1", "160");
		builder.AddAttribute(57, "x2", "48");
		builder.AddAttribute(58, "y2", "160");
		builder.CloseElement();
		builder.CloseElement();
    }
}
