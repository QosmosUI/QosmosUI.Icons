...
public class IoArrowDownOutline : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(14, "points", "112 268 256 412 400 268");
		...
		builder.AddAttribute(21, "y1", "392");
		builder.AddAttribute(22, "x2", "256");
		builder.AddAttribute(23, "y2", "100");
