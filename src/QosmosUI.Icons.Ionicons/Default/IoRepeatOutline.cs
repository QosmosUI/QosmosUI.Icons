...
public class IoRepeatOutline : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(14, "points", "320 120 368 168 320 216");
		...
		builder.AddAttribute(20, "d", "M352,168H144a80.24,80.24,0,0,0-80,80v16");
		...
		builder.AddAttribute(26, "points", "192 392 144 344 192 296");
		...
		builder.AddAttribute(32, "d", "M160,344H368a80.24,80.24,0,0,0,80-80V248");
