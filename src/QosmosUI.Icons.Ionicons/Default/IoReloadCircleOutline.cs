...
public class IoReloadCircleOutline : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(19, "d", "M341.54,197.85l-11.37-13.23a103.37,103.37,0,1,0,22.71,105.84");
		...
		builder.AddAttribute(25, "d", "M367.32,162a8.44,8.44,0,0,0-6,2.54l-59.54,59.54a8.61,8.61,0,0,0,6.09,14.71h59.54a8.62,8.62,0,0,0,8.62-8.62V170.61a8.61,8.61,0,0,0-8.68-8.63Z");
		builder.CloseElement();
		builder.CloseElement();
    }
}
