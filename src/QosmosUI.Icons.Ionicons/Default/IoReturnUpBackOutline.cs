...
public class IoReturnUpBackOutline : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(14, "points", "112 160 48 224 112 288");
		...
		builder.AddAttribute(20, "d", "M64,224H358c58.76,0,106,49.33,106,108v20");
