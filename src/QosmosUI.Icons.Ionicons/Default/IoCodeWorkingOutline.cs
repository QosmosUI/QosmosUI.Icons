...
public class IoCodeWorkingOutline : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(26, "points", "160 368 32 256 160 144");
		...
		builder.AddAttribute(32, "points", "352 368 480 256 352 144");
