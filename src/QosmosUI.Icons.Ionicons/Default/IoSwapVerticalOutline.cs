...
public class IoSwapVerticalOutline : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(14, "points", "464 208 352 96 240 208");
		...
		builder.AddAttribute(20, "x1", "352");
		builder.AddAttribute(21, "y1", "113.13");
		builder.AddAttribute(22, "x2", "352");
		builder.AddAttribute(23, "y2", "416");
		...
		builder.AddAttribute(29, "points", "48 304 160 416 272 304");
		...
		builder.AddAttribute(35, "x1", "160");
		builder.AddAttribute(36, "y1", "398");
		builder.AddAttribute(37, "x2", "160");
		builder.AddAttribute(38, "y2", "96");
