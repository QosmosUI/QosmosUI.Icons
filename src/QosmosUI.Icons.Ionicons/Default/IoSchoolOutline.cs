...
public class IoSchoolOutline : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(14, "points", "32 192 256 64 480 192 256 320 32 192");
		...
		builder.AddAttribute(20, "points", "112 240 112 368 256 448 400 368 400 240");
		...
		builder.AddAttribute(26, "x1", "480");
		builder.AddAttribute(27, "y1", "368");
		builder.AddAttribute(28, "x2", "480");
		...
		builder.AddAttribute(36, "y1", "320");
		builder.AddAttribute(37, "x2", "256");
		builder.AddAttribute(38, "y2", "448");
