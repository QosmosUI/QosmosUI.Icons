...
public class IoBagAddOutline : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(17, "y2", "384");
		...
		builder.AddAttribute(23, "x1", "320");
		builder.AddAttribute(24, "y1", "320");
		builder.AddAttribute(25, "x2", "192");
		builder.AddAttribute(26, "y2", "320");
		...
		builder.AddAttribute(32, "d", "M80,176a16,16,0,0,0-16,16V408c0,30.24,25.76,56,56,56H392c30.24,0,56-24.51,56-54.75V192a16,16,0,0,0-16-16Z");
		...
		builder.AddAttribute(36, "stroke-width", "32");
		builder.AddAttribute(37, "fill-rule", "evenodd");
		builder.CloseElement();
		builder.OpenElement(38, "path");
		builder.AddAttribute(39, "d", "M160,176V144a96,96,0,0,1,96-96h0a96,96,0,0,1,96,96v32");
