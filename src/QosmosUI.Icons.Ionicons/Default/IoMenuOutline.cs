...
public class IoMenuOutline : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(14, "x1", "80");
		builder.AddAttribute(15, "y1", "160");
		builder.AddAttribute(16, "x2", "432");
		builder.AddAttribute(17, "y2", "160");
		...
		builder.AddAttribute(23, "x1", "80");
		builder.AddAttribute(24, "y1", "256");
		builder.AddAttribute(25, "x2", "432");
		...
		builder.AddAttribute(34, "x2", "432");
		builder.AddAttribute(35, "y2", "352");
