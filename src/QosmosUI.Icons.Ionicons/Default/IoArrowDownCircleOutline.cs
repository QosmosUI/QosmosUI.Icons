...
public class IoArrowDownCircleOutline : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(14, "points", "176 262.62 256 342 336 262.62");
		...
		builder.AddAttribute(21, "y1", "330.97");
		builder.AddAttribute(22, "x2", "256");
		builder.AddAttribute(23, "y2", "170");
		...
		builder.AddAttribute(29, "d", "M256,64C150,64,64,150,64,256s86,192,192,192,192-86,192-192S362,64,256,64Z");
