...
public class IoArrowBackCircleOutline : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(14, "points", "249.38 336 170 256 249.38 176");
		...
		builder.AddAttribute(20, "x1", "181.03");
		builder.AddAttribute(21, "y1", "256");
		builder.AddAttribute(22, "x2", "342");
		...
		builder.AddAttribute(29, "d", "M448,256c0-106-86-192-192-192S64,150,64,256s86,192,192,192S448,362,448,256Z");
