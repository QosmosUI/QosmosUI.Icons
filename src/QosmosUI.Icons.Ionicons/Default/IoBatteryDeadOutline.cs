...
public class IoBatteryDeadOutline : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(25, "x1", "479");
		builder.AddAttribute(26, "y1", "218.67");
		builder.AddAttribute(27, "x2", "479");
		builder.AddAttribute(28, "y2", "293.33");
