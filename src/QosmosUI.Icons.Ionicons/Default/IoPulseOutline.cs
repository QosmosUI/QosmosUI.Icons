...
public class IoPulseOutline : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(14, "points", "48 320 112 320 176 64 240 448 304 224 336 320 400 320");
		...
		builder.AddAttribute(20, "cx", "432");
		builder.AddAttribute(21, "cy", "320");
