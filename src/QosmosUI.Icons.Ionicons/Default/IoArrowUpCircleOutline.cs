...
public class IoArrowUpCircleOutline : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(14, "points", "176 249.38 256 170 336 249.38");
		...
		builder.AddAttribute(21, "y1", "181.03");
		builder.AddAttribute(22, "x2", "256");
		builder.AddAttribute(23, "y2", "342");
