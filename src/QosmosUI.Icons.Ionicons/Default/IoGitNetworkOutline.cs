...
public class IoGitNetworkOutline : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(31, "y1", "256");
		...
		builder.AddAttribute(39, "cx", "384");
		builder.AddAttribute(40, "cy", "96");
		...
		builder.AddAttribute(47, "d", "M128,144c0,74.67,68.92,112,128,112");
		...
		builder.AddAttribute(53, "d", "M384,144c0,74.67-68.92,112-128,112");
