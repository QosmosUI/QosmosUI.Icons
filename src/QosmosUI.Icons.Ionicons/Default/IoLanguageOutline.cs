...
public class IoLanguageOutline : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(17, "y2", "112");
		...
		builder.AddAttribute(23, "x1", "192");
		builder.AddAttribute(24, "y1", "64");
		builder.AddAttribute(25, "x2", "192");
		builder.AddAttribute(26, "y2", "112");
		...
		builder.AddAttribute(32, "points", "272 448 368 224 464 448");
		...
		builder.AddAttribute(38, "x1", "301.5");
		builder.AddAttribute(39, "y1", "384");
		builder.AddAttribute(40, "x2", "434.5");
		builder.AddAttribute(41, "y2", "384");
		...
		builder.AddAttribute(47, "d", "M281.3,112S257,206,199,277,80,384,80,384");
		...
		builder.AddAttribute(53, "d", "M256,336s-35-27-72-75-56-85-56-85");
