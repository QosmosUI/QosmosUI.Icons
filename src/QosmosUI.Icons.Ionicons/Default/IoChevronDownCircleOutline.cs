...
public class IoChevronDownCircleOutline : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(14, "d", "M256,64C150,64,64,150,64,256s86,192,192,192,192-86,192-192S362,64,256,64Z");
		...
		builder.AddAttribute(19, "points", "352 216 256 312 160 216");
