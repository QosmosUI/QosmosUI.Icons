...
public class IoLinkOutline : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(14, "d", "M208,352H144a96,96,0,0,1,0-192h64");
		builder.AddAttribute(15, "fill", "none");
		builder.AddAttribute(16, "stroke-linecap", "round");
		builder.AddAttribute(17, "stroke-linejoin", "round");
		builder.AddAttribute(18, "stroke-width", "36px");
		builder.CloseElement();
		builder.OpenElement(19, "path");
		builder.AddAttribute(20, "d", "M304,160h64a96,96,0,0,1,0,192H304");
		...
		builder.AddAttribute(24, "stroke-width", "36px");
		builder.CloseElement();
		builder.OpenElement(25, "line");
		builder.AddAttribute(26, "x1", "163.29");
		builder.AddAttribute(27, "y1", "256");
		builder.AddAttribute(28, "x2", "350.71");
		...
		builder.AddAttribute(33, "stroke-width", "36px");
		builder.CloseElement();
		builder.CloseElement();
    }
}
