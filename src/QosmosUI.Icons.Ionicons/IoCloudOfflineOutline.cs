...
public class IoCloudOfflineOutline : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(14, "d", "M93.72,183.25C49.49,198.05,16,233.1,16,288c0,66,54,112,120,112H320.37");
		...
		builder.AddAttribute(20, "d", "M467.82,377.74C485.24,363.3,496,341.61,496,312c0-59.82-53-85.76-96-88-8.89-89.54-71-144-144-144-26.16,0-48.79,6.93-67.6,18.14");
		...
		builder.AddAttribute(26, "x1", "448");
		builder.AddAttribute(27, "y1", "448");
		builder.AddAttribute(28, "x2", "64");
		builder.AddAttribute(29, "y2", "64");
