...
public class IoGitMergeOutline : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(14, "cx", "129");
		...
		builder.AddAttribute(22, "cx", "129");
		...
		builder.AddAttribute(30, "x1", "129");
		builder.AddAttribute(31, "y1", "144");
		builder.AddAttribute(32, "x2", "129");
		...
		builder.AddAttribute(39, "cx", "385");
		builder.AddAttribute(40, "cy", "288");
		...
		builder.AddAttribute(47, "d", "M129,144c0,96,112,144,208,144");
