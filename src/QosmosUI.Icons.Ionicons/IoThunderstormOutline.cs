...
public class IoThunderstormOutline : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(14, "x1", "120");
		builder.AddAttribute(15, "y1", "352");
		...
		builder.AddAttribute(23, "x1", "136");
		builder.AddAttribute(24, "y1", "432");
		builder.AddAttribute(25, "x2", "120");
		...
		builder.AddAttribute(32, "x1", "400");
		builder.AddAttribute(33, "y1", "352");
		builder.AddAttribute(34, "x2", "376");
		builder.AddAttribute(35, "y2", "400");
		...
		builder.AddAttribute(41, "x1", "416");
		builder.AddAttribute(42, "y1", "432");
		builder.AddAttribute(43, "x2", "400");
		builder.AddAttribute(44, "y2", "464");
		...
		builder.AddAttribute(50, "points", "208 304 192 400 240 400 240 480 320 368 272 368 288 304");
		...
		builder.AddAttribute(56, "d", "M404.33,152.89H392.2C384.71,84.85,326.14,32,256,32a136.39,136.39,0,0,0-128.63,90.67H122.8c-49.94,0-90.8,40.8-90.8,90.66h0C32,263.2,72.86,304,122.8,304H404.33C446,304,480,270,480,228.44h0C480,186.89,446,152.89,404.33,152.89Z");
