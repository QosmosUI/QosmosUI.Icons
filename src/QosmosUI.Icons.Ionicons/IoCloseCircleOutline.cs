...
public class IoCloseCircleOutline : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(19, "x1", "320");
		builder.AddAttribute(20, "y1", "320");
		builder.AddAttribute(21, "x2", "192");
		builder.AddAttribute(22, "y2", "192");
		...
		builder.AddAttribute(28, "x1", "192");
		builder.AddAttribute(29, "y1", "320");
		builder.AddAttribute(30, "x2", "320");
		builder.AddAttribute(31, "y2", "192");
