...
public class TiThSmall : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(14, "cx", "5");
		builder.AddAttribute(15, "cy", "19");
		builder.AddAttribute(16, "r", "2.5");
		builder.CloseElement();
		builder.OpenElement(17, "circle");
		builder.AddAttribute(18, "cx", "5");
		builder.AddAttribute(19, "cy", "12");
		builder.AddAttribute(20, "r", "2.5");
		builder.CloseElement();
		builder.OpenElement(21, "circle");
		builder.AddAttribute(22, "cx", "5");
		builder.AddAttribute(23, "cy", "5");
		builder.AddAttribute(24, "r", "2.5");
		builder.CloseElement();
		...
		builder.AddAttribute(32, "r", "2.5");
		builder.CloseElement();
		builder.OpenElement(33, "circle");
		builder.AddAttribute(34, "cx", "12");
		builder.AddAttribute(35, "cy", "5");
		builder.AddAttribute(36, "r", "2.5");
		builder.CloseElement();
		builder.OpenElement(37, "circle");
		builder.AddAttribute(38, "cx", "19");
		builder.AddAttribute(39, "cy", "19");
		builder.AddAttribute(40, "r", "2.5");
		builder.CloseElement();
		builder.OpenElement(41, "circle");
		builder.AddAttribute(42, "cx", "19");
		builder.AddAttribute(43, "cy", "12");
		builder.AddAttribute(44, "r", "2.5");
		builder.CloseElement();
		builder.OpenElement(45, "circle");
		builder.AddAttribute(46, "cx", "19");
		builder.AddAttribute(47, "cy", "5");
		builder.AddAttribute(48, "r", "2.5");
		builder.CloseElement();
		builder.CloseElement();
    }
}
