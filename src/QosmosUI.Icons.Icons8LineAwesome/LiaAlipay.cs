...
public class LiaAlipay : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(14, "d", "M5,5v22h22V5H5z M7,7h18v18H7V7z");
		builder.CloseElement();
		builder.OpenElement(15, "rect");
		builder.AddAttribute(16, "width", "2");
		builder.AddAttribute(17, "height", "5");
		builder.AddAttribute(18, "x", "15");
		builder.AddAttribute(19, "y", "9");
		builder.CloseElement();
