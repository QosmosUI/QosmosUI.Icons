...
public class LuNetwork : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(32, "d", "M5 16v-3a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1v3");
		builder.CloseElement();
		builder.OpenElement(33, "path");
		builder.AddAttribute(34, "d", "M12 12V8");
		builder.CloseElement();
		builder.CloseElement();
    }
}
