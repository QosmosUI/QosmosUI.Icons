...
public class LuGamepad : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(22, "y2", "14");
		builder.CloseElement();
		builder.OpenElement(23, "line");
		builder.AddAttribute(24, "x1", "15");
		builder.AddAttribute(25, "x2", "15.01");
		builder.AddAttribute(26, "y1", "13");
		builder.AddAttribute(27, "y2", "13");
		builder.CloseElement();
		builder.OpenElement(28, "line");
		builder.AddAttribute(29, "x1", "18");
		builder.AddAttribute(30, "x2", "18.01");
		builder.AddAttribute(31, "y1", "11");
		builder.AddAttribute(32, "y2", "11");
		builder.CloseElement();
		builder.OpenElement(33, "rect");
		builder.AddAttribute(34, "width", "20");
		builder.AddAttribute(35, "height", "12");
		builder.AddAttribute(36, "x", "2");
		builder.AddAttribute(37, "y", "6");
		builder.AddAttribute(38, "rx", "2");
		builder.CloseElement();
		builder.CloseElement();
    }
}
