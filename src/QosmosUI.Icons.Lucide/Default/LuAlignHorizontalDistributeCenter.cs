...
public class LuAlignHorizontalDistributeCenter : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(14, "width", "6");
		...
		builder.AddAttribute(20, "width", "6");
		...
		builder.AddAttribute(26, "d", "M17 22v-5");
		builder.CloseElement();
		builder.OpenElement(27, "path");
		builder.AddAttribute(28, "d", "M17 7V2");
		builder.CloseElement();
		builder.OpenElement(29, "path");
		builder.AddAttribute(30, "d", "M7 22v-3");
		builder.CloseElement();
		builder.OpenElement(31, "path");
		builder.AddAttribute(32, "d", "M7 5V2");
		builder.CloseElement();
		builder.CloseElement();
    }
}
