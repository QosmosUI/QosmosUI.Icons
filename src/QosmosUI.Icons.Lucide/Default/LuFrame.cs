...
public class LuFrame : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(15, "x2", "2");
		builder.AddAttribute(16, "y1", "6");
		builder.AddAttribute(17, "y2", "6");
		builder.CloseElement();
		builder.OpenElement(18, "line");
		builder.AddAttribute(19, "x1", "22");
		builder.AddAttribute(20, "x2", "2");
		builder.AddAttribute(21, "y1", "18");
		builder.AddAttribute(22, "y2", "18");
		builder.CloseElement();
		builder.OpenElement(23, "line");
		builder.AddAttribute(24, "x1", "6");
		builder.AddAttribute(25, "x2", "6");
		builder.AddAttribute(26, "y1", "2");
		builder.AddAttribute(27, "y2", "22");
		builder.CloseElement();
		builder.OpenElement(28, "line");
		builder.AddAttribute(29, "x1", "18");
		builder.AddAttribute(30, "x2", "18");
		builder.AddAttribute(31, "y1", "2");
