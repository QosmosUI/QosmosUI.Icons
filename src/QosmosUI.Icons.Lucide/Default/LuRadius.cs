...
public class LuRadius : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(14, "d", "M20.34 17.52a10 10 0 1 0-2.82 2.82");
		builder.CloseElement();
		builder.OpenElement(15, "circle");
		builder.AddAttribute(16, "cx", "19");
		builder.AddAttribute(17, "cy", "19");
		builder.AddAttribute(18, "r", "2");
		builder.CloseElement();
		builder.OpenElement(19, "path");
		builder.AddAttribute(20, "d", "m13.41 13.41 4.18 4.18");
		builder.CloseElement();
