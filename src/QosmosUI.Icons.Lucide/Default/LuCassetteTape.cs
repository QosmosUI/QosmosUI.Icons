...
public class LuCassetteTape : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(24, "d", "M8 12h8");
		builder.CloseElement();
		...
		builder.AddAttribute(30, "d", "m6 20 .7-2.9A1.4 1.4 0 0 1 8.1 16h7.8a1.4 1.4 0 0 1 1.4 1l.7 3");
		builder.CloseElement();
		builder.CloseElement();
    }
}
