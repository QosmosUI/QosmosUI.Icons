...
public class LuGrip : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(43, "cy", "19");
		builder.AddAttribute(44, "r", "1");
		builder.CloseElement();
		builder.OpenElement(45, "circle");
		builder.AddAttribute(46, "cx", "5");
		builder.AddAttribute(47, "cy", "19");
