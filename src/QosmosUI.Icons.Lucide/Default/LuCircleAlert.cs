...
public class LuCircleAlert : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(20, "y1", "8");
		builder.AddAttribute(21, "y2", "12");
		builder.CloseElement();
		builder.OpenElement(22, "line");
		builder.AddAttribute(23, "x1", "12");
		builder.AddAttribute(24, "x2", "12.01");
		builder.AddAttribute(25, "y1", "16");
		builder.AddAttribute(26, "y2", "16");
		builder.CloseElement();
		builder.CloseElement();
    }
}
