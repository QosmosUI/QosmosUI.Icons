...
public class LuHardDrive : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(19, "d", "M5.45 5.11 2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.45-6.89A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11z");
		builder.CloseElement();
		builder.OpenElement(20, "line");
		builder.AddAttribute(21, "x1", "6");
		builder.AddAttribute(22, "x2", "6.01");
		builder.AddAttribute(23, "y1", "16");
		builder.AddAttribute(24, "y2", "16");
		builder.CloseElement();
		builder.OpenElement(25, "line");
		builder.AddAttribute(26, "x1", "10");
		builder.AddAttribute(27, "x2", "10.01");
		builder.AddAttribute(28, "y1", "16");
