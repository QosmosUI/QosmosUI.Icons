...
public class LuSheet : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(22, "x2", "21");
		builder.AddAttribute(23, "y1", "9");
		builder.AddAttribute(24, "y2", "9");
		builder.CloseElement();
		builder.OpenElement(25, "line");
		builder.AddAttribute(26, "x1", "3");
		builder.AddAttribute(27, "x2", "21");
		builder.AddAttribute(28, "y1", "15");
		builder.AddAttribute(29, "y2", "15");
		builder.CloseElement();
		builder.OpenElement(30, "line");
		builder.AddAttribute(31, "x1", "9");
		builder.AddAttribute(32, "x2", "9");
		builder.AddAttribute(33, "y1", "9");
		builder.AddAttribute(34, "y2", "21");
		builder.CloseElement();
		builder.OpenElement(35, "line");
		builder.AddAttribute(36, "x1", "15");
		builder.AddAttribute(37, "x2", "15");
		builder.AddAttribute(38, "y1", "9");
		builder.AddAttribute(39, "y2", "21");
		builder.CloseElement();
		builder.CloseElement();
    }
}
