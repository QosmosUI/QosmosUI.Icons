...
public class LuCircuitBoard : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(20, "d", "M11 9h4a2 2 0 0 0 2-2V3");
		builder.CloseElement();
		...
		builder.AddAttribute(26, "d", "M7 21v-4a2 2 0 0 1 2-2h4");
		builder.CloseElement();
		builder.OpenElement(27, "circle");
		builder.AddAttribute(28, "cx", "15");
