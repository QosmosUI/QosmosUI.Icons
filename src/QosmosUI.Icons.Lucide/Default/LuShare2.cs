...
public class LuShare2 : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(27, "x2", "15.42");
		builder.AddAttribute(28, "y1", "13.51");
		builder.AddAttribute(29, "y2", "17.49");
		builder.CloseElement();
		builder.OpenElement(30, "line");
		builder.AddAttribute(31, "x1", "15.41");
		builder.AddAttribute(32, "x2", "8.59");
		builder.AddAttribute(33, "y1", "6.51");
