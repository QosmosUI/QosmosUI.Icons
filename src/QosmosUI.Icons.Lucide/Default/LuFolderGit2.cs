...
public class LuFolderGit2 : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(14, "d", "M9 20H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h3.9a2 2 0 0 1 1.69.9l.81 1.2a2 2 0 0 0 1.67.9H20a2 2 0 0 1 2 2v5");
		builder.CloseElement();
		...
		builder.AddAttribute(20, "d", "M18 19c-2.8 0-5-2.2-5-5v8");
		builder.CloseElement();
