...
public class LuGitPullRequestDraft : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(22, "d", "M18 6V5");
		builder.CloseElement();
		builder.OpenElement(23, "path");
		builder.AddAttribute(24, "d", "M18 11v-1");
		builder.CloseElement();
		builder.OpenElement(25, "line");
		builder.AddAttribute(26, "x1", "6");
		builder.AddAttribute(27, "x2", "6");
		builder.AddAttribute(28, "y1", "9");
		builder.AddAttribute(29, "y2", "21");
		builder.CloseElement();
		builder.CloseElement();
    }
}
