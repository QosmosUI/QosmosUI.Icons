...
public class LuMicOff : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(19, "d", "M18.89 13.23A7.12 7.12 0 0 0 19 12v-2");
		builder.CloseElement();
		builder.OpenElement(20, "path");
		builder.AddAttribute(21, "d", "M5 10v2a7 7 0 0 0 12 5");
		builder.CloseElement();
		builder.OpenElement(22, "path");
		builder.AddAttribute(23, "d", "M15 9.34V5a3 3 0 0 0-5.68-1.33");
		builder.CloseElement();
		builder.OpenElement(24, "path");
		builder.AddAttribute(25, "d", "M9 9v3a3 3 0 0 0 5.12 2.12");
		builder.CloseElement();
		builder.OpenElement(26, "line");
		builder.AddAttribute(27, "x1", "12");
		builder.AddAttribute(28, "x2", "12");
		builder.AddAttribute(29, "y1", "19");
