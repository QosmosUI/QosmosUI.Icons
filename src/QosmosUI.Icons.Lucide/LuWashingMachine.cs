...
public class LuWashingMachine : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(14, "d", "M3 6h3");
		builder.CloseElement();
		builder.OpenElement(15, "path");
		builder.AddAttribute(16, "d", "M17 6h.01");
		builder.CloseElement();
		...
		builder.AddAttribute(28, "d", "M12 18a2.5 2.5 0 0 0 0-5 2.5 2.5 0 0 1 0-5");
		builder.CloseElement();
		builder.CloseElement();
    }
}
