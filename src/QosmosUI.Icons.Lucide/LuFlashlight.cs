...
public class LuFlashlight : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(14, "d", "M18 6c0 2-2 2-2 4v10a2 2 0 0 1-2 2h-4a2 2 0 0 1-2-2V10c0-2-2-2-2-4V2h12z");
		builder.CloseElement();
		builder.OpenElement(15, "line");
		builder.AddAttribute(16, "x1", "6");
		builder.AddAttribute(17, "x2", "18");
