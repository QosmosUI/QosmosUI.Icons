...
public class LuTangent : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(18, "d", "M15.59 5.41 5.41 15.59");
		builder.CloseElement();
		builder.OpenElement(19, "circle");
		builder.AddAttribute(20, "cx", "4");
		builder.AddAttribute(21, "cy", "17");
		builder.AddAttribute(22, "r", "2");
		builder.CloseElement();
		builder.OpenElement(23, "path");
		builder.AddAttribute(24, "d", "M12 22s-4-9-1.5-11.5S22 12 22 12");
		builder.CloseElement();
		builder.CloseElement();
    }
}
