...
public class LuMonitor : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(22, "y1", "21");
		builder.AddAttribute(23, "y2", "21");
		builder.CloseElement();
		builder.OpenElement(24, "line");
		builder.AddAttribute(25, "x1", "12");
		builder.AddAttribute(26, "x2", "12");
		builder.AddAttribute(27, "y1", "17");
		builder.AddAttribute(28, "y2", "21");
		builder.CloseElement();
		builder.CloseElement();
    }
}
