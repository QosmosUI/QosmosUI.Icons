...
public class LuGitGraph : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(18, "d", "M5 9v6");
		builder.CloseElement();
		...
		builder.AddAttribute(24, "d", "M12 3v18");
		builder.CloseElement();
		...
		builder.AddAttribute(30, "d", "M16 15.7A9 9 0 0 0 19 9");
		builder.CloseElement();
		builder.CloseElement();
    }
}
