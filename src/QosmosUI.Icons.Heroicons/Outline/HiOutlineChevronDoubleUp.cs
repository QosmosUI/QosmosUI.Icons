...
public class HiOutlineChevronDoubleUp : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(16, "d", "m4.5 18.75 7.5-7.5 7.5 7.5");
		builder.CloseElement();
		builder.OpenElement(17, "path");
		builder.AddAttribute(18, "stroke-linecap", "round");
		builder.AddAttribute(19, "stroke-linejoin", "round");
		builder.AddAttribute(20, "d", "m4.5 12.75 7.5-7.5 7.5 7.5");
		builder.CloseElement();
		builder.CloseElement();
    }
}
