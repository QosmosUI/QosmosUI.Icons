...
public class HiOutlineChartPie : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(16, "d", "M10.5 6a7.5 7.5 0 1 0 7.5 7.5h-7.5V6Z");
		builder.CloseElement();
		builder.OpenElement(17, "path");
		builder.AddAttribute(18, "stroke-linecap", "round");
		builder.AddAttribute(19, "stroke-linejoin", "round");
		builder.AddAttribute(20, "d", "M13.5 10.5H21A7.5 7.5 0 0 0 13.5 3v7.5Z");
		builder.CloseElement();
		builder.CloseElement();
    }
}
