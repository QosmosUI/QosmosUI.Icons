...
public class FcRemoveImage : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(37, "transform", "matrix(-.707 .707 -.707 -.707 91.74 38)");
		builder.AddAttribute(38, "width", "3");
		builder.AddAttribute(39, "height", "12");
		builder.CloseElement();
		builder.OpenElement(40, "rect");
		builder.AddAttribute(41, "x", "36.5");
		builder.AddAttribute(42, "y", "32");
		builder.AddAttribute(43, "transform", "matrix(-.707 -.707 .707 -.707 38 91.74)");
		builder.AddAttribute(44, "width", "3");
		builder.AddAttribute(45, "height", "12");
		builder.CloseElement();
		builder.CloseElement();
		builder.CloseElement();
    }
