...
public class FcPositiveDynamic : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(33, "points", "11,8 21,18 21,8");
		builder.CloseElement();
		builder.OpenElement(34, "rect");
		builder.AddAttribute(35, "x", "11");
		builder.AddAttribute(36, "y", "8.9");
		builder.AddAttribute(37, "transform", "matrix(-.707 -.707 .707 -.707 10.879 36.506)");
