...
public class FcInfo : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(20, "y", "22");
		builder.AddAttribute(21, "fill", "#fff");
		builder.AddAttribute(22, "width", "4");
		builder.AddAttribute(23, "height", "11");
		builder.CloseElement();
		builder.OpenElement(24, "circle");
		builder.AddAttribute(25, "fill", "#fff");
		builder.AddAttribute(26, "cx", "24");
		builder.AddAttribute(27, "cy", "16.5");
