...
public class FcPrivacy : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(20, "fill", "#EFEBE9");
		builder.AddAttribute(21, "cx", "24");
		builder.AddAttribute(22, "cy", "31");
		builder.AddAttribute(23, "r", "6");
		builder.CloseElement();
		builder.OpenElement(24, "circle");
		builder.AddAttribute(25, "fill", "#1E88E5");
		...
		builder.AddAttribute(31, "cx", "26");
		builder.AddAttribute(32, "cy", "29");
