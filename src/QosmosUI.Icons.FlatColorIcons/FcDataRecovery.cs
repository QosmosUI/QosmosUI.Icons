...
public class FcDataRecovery : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(24, "x", "35");
		builder.AddAttribute(25, "y", "28");
		builder.AddAttribute(26, "width", "6");
		builder.AddAttribute(27, "height", "20");
		builder.CloseElement();
		builder.OpenElement(28, "rect");
		builder.AddAttribute(29, "x", "28");
		builder.AddAttribute(30, "y", "35");
		builder.AddAttribute(31, "width", "20");
		builder.AddAttribute(32, "height", "6");
		builder.CloseElement();
		builder.CloseElement();
		builder.CloseElement();
    }
