...
public class FcManager : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(30, "fill", "#FF5722");
		...
		builder.AddAttribute(43, "fill", "#CFD8DC");
		builder.AddAttribute(44, "d", "M29,31L29,31l-5,1l-5-1c0,0-11,2-11,13h32C40,33,29,31,29,31z");
		builder.CloseElement();
		builder.OpenElement(45, "polygon");
		builder.AddAttribute(46, "fill", "#3F51B5");
		builder.AddAttribute(47, "points", "23,35 22,44 26,44 25,35 26,34 24,32 22,34");
		builder.CloseElement();
		builder.CloseElement();
    }
}
