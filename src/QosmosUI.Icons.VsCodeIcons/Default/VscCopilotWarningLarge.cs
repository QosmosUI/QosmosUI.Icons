...
public class VscCopilotWarningLarge : ComponentBase
{
    [Parameter]
    public string Title { get; set; } = string.Empty;

    [Parameter]
    public string Size { get; set; } = "47";
    ...
    [Parameter]
    public string ViewBox { get; set; } = "0 0 47 43";
