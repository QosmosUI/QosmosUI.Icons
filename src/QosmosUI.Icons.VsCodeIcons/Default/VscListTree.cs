...
public class VscListTree : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(16, "width", "9");
		builder.AddAttribute(17, "height", "1");
		builder.CloseElement();
		builder.OpenElement(18, "rect");
		builder.AddAttribute(19, "x", "4");
		builder.AddAttribute(20, "y", "12");
		...
		builder.AddAttribute(34, "x", "4");
		builder.AddAttribute(35, "y", "4");
		builder.AddAttribute(36, "width", "1");
		builder.AddAttribute(37, "height", "9");
		builder.CloseElement();
		builder.CloseElement();
    }
}
