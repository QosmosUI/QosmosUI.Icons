...
public class FiShoppingBag : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(14, "d", "M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z");
		builder.CloseElement();
		...
		builder.AddAttribute(21, "d", "M16 10a4 4 0 0 1-8 0");
		builder.CloseElement();
		builder.CloseElement();
    }
}
