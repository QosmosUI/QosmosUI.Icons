...
public class FiCalendar : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(24, "y2", "6");
		builder.CloseElement();
		builder.OpenElement(25, "line");
		builder.AddAttribute(26, "x1", "8");
		builder.AddAttribute(27, "y1", "2");
		builder.AddAttribute(28, "x2", "8");
		builder.AddAttribute(29, "y2", "6");
		builder.CloseElement();
		builder.OpenElement(30, "line");
		builder.AddAttribute(31, "x1", "3");
		builder.AddAttribute(32, "y1", "10");
		builder.AddAttribute(33, "x2", "21");
		builder.AddAttribute(34, "y2", "10");
		builder.CloseElement();
		builder.CloseElement();
    }
}
