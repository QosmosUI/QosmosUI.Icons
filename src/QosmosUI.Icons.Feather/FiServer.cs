...
public class FiServer : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(24, "height", "8");
		...
		builder.AddAttribute(30, "x2", "6.01");
		builder.AddAttribute(31, "y2", "6");
		builder.CloseElement();
		builder.OpenElement(32, "line");
		builder.AddAttribute(33, "x1", "6");
		builder.AddAttribute(34, "y1", "18");
		builder.AddAttribute(35, "x2", "6.01");
