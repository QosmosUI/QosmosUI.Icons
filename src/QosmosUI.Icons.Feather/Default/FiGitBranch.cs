...
public class FiGitBranch : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(15, "y1", "3");
		builder.AddAttribute(16, "x2", "6");
		...
		builder.AddAttribute(24, "cy", "18");
		builder.AddAttribute(25, "r", "3");
		builder.CloseElement();
		builder.OpenElement(26, "path");
		builder.AddAttribute(27, "d", "M18 9a9 9 0 0 1-9 9");
		builder.CloseElement();
		builder.CloseElement();
    }
}
