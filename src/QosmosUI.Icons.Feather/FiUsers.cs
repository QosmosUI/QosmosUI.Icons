...
public class FiUsers : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(14, "d", "M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2");
		builder.CloseElement();
		...
		builder.AddAttribute(20, "d", "M23 21v-2a4 4 0 0 0-3-3.87");
		builder.CloseElement();
