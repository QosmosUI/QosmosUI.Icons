...
public class CiBookmarkMinus : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(14, "id", "Bookmark_Minus");
		builder.AddAttribute(15, "data-name", "Bookmark Minus");
		...
		builder.AddAttribute(20, "d", "M10,10.277a.5.5,0,0,1,0-1h4a.5.5,0,0,1,0,1Z");
		builder.CloseElement();
		builder.CloseElement();
		builder.CloseElement();
		builder.CloseElement();
