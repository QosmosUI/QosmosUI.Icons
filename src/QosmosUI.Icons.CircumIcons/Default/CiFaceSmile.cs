...
public class CiFaceSmile : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(14, "id", "Face_Smile");
		builder.AddAttribute(15, "data-name", "Face Smile");
		...
		builder.AddAttribute(20, "d", "M16.693,13.744a5.041,5.041,0,0,1-9.387,0c-.249-.59-1.111-.081-.863.505a6.026,6.026,0,0,0,11.114,0c.247-.586-.614-1.1-.864-.505Z");
		builder.CloseElement();
