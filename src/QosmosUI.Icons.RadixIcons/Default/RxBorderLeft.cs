...
public class RxBorderLeft : ComponentBase
{
    [Parameter]
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
		...
		builder.AddAttribute(16, "d", "M1.75 1L1.75 14L0.249999 14L0.25 1L1.75 1Z");
		builder.AddAttribute(17, "fill", "currentColor");
		builder.CloseElement();
		builder.OpenElement(18, "rect");
		builder.AddAttribute(19, "x", "10");
		builder.AddAttribute(20, "y", "7");
		builder.AddAttribute(21, "width", "1");
		builder.AddAttribute(22, "height", "1");
		builder.AddAttribute(23, "rx", ".5");
		builder.AddAttribute(24, "transform", "rotate(90 10 7)");
